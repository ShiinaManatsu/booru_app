...
bool _hasNotificationsDll() {
  // In CI / `flutter test`, the native DLL is often not built/copied.
  // Skip these FFI tests in that case.
  const candidates = <String>[
    'flutter_local_notifications_windows.dll',
    'build/windows/x64/runner/Release/flutter_local_notifications_windows.dll',
    'build/windows/x64/runner/Debug/flutter_local_notifications_windows.dll',
  ];
...
void main() => group(
      ...
      skip: !_hasNotificationsDll() ? 'Native DLL not present for FFI tests.' : false,
    );
