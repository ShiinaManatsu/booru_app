  ...
  Widget build(BuildContext context) {
    ...
    return SliverList(
      delegate: SliverChildListDelegate([
        SizedBox(height: AppSettings.masonryGridSpacing),
                ...
                return !AppSettings.masonryGrid
                    ...
                    : Padding(
                        padding: EdgeInsets.symmetric(
                            horizontal: AppSettings.masonryGridSpacing + 4,
                            vertical: AppSettings.masonryGridSpacing),
                        child: MasonryGrid(
                            staggered: false,
                            crossAxisSpacing: AppSettings.masonryGridSpacing,
                            mainAxisSpacing: AppSettings.masonryGridSpacing,
                            column: size.width ~/
                                (size.aspectRatio > 1 ? 300 : 200),
